; ModuleID = '/mayhem/analyzer/test/regression/dfa/test-5-delete-array.cpp'
...
define dso_local noundef i32 @main() #0 {
  ...
  %4 = call noalias noundef nonnull i8* @_Znam(i64 noundef 42) #3
...
9:                                                ; preds = %0
  ...
  call void @_ZdaPv(i8* noundef %10) #4
  br label %11
...
14:                                               ; preds = %11
  ...
  call void @_ZdaPv(i8* noundef %15) #4
  br label %16
...
declare dso_local void @_ZdaPv(i8* noundef) #2
