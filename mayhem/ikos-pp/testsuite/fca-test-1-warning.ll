; ModuleID = '/mayhem/analyzer/test/regression/fca/test-1-warning.c'
...
define dso_local i32 @main() #0 {
  ...
  store i8* bitcast (void (double)* @b to i8*), i8** %6, align 8
  %7 = getelementptr inbounds [3 x i8*], [3 x i8*]* %2, i64 0, i64 2
  store i8* bitcast (void (i32*)* @c to i8*), i8** %7, align 16
...
; Function Attrs: noinline nounwind uwtable
define internal void @b(double noundef %0) #0 {
...
; Function Attrs: noinline nounwind uwtable
define internal void @c(i32* noundef %0) #0 {
